...
f = open("/home/abysshub_bots/stack.txt", "r")
counter = f.read()
f.close()
...
try:
    ...
    webdriver.get(f'https://stackoverflow.com/questions?tab=votes&page={counter}')
    ...
    for link in hrefs:
        ...
        for answer in answers:
            ...
            loop = loop + 1
    print(f'finished {counter}. loop')
except:
    print('Error, restarting again...')
    sleep(1)

f = open("/home/abysshub_bots/stack.txt", "w")  
