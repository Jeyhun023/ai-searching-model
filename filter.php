...
$text = "Lorem Ipsum, masaüstü yayıncılık ve basın yayın
 sektöründe kullanılan taklit yazı  bloğu olarak tanımlanır. 
 Lipsum, oluşturulacak şablon  ve taslaklarda içerik yerine geçerek 
 yazı bloğunu doldurmak için kullanılır.";


$string = explode(" ", $text);

foreach($string as $string1){
    foreach($badwords as $string2){
        $o = new SmithWatermanGotoh();
        $percent = $o->compare($string1, $string2);
        if($percent > 0.8){
            echo $percent;
        }
    }
